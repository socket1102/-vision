    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
       ...
       <a-form-item
          ...
          label="人脸图片">
              <j-image-upload v-decorator="['faceImagePath']"></j-image-upload>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','activitiSync','workNo','telephone','post','faceImagePath'))
        });
        //身份为上级显示负责部门，否则不显示
